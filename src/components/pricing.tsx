...
export default function Pricing() {
  return (
    <div className="flex flex-col items-center w-full h-screen gap-6 p-6">
      <div className="flex flex-col justify-center gap-8 w-[530px] h-1/3 text-center">
        <p className="text-[48px] leading-[48px] font-extrabold">
          Pricing & Plans
        </p>
        <p className="text-[20px] leading-[24px] font-extrabold">
      ...
      <div className="flex gap-2 flex-1 w-full h-2/3">
        <a
          href="https://app.dataminion.ai"
          className="w-1/4 h-full p-8 space-y-2 border border-lightSlate rounded-3xl transition-colors hover:bg-lightSlate"
        >
