...
export default function Privacy() {
  return (
    <div className="h-screen p-4 box-border">
      <div className="flex flex-col md:flex-row justify-center md:gap-8 p-8 md:p-[10vw] bg-darkSlate rounded-3xl size-full box-border">
        <div className="flex flex-col justify-center md:justify-start items-center md:items-start gap-4 w-auto h-1/3 md:h-auto md:w-1/3">
          <img src={animation} className="w-48 object-contain"></img>
          <p className="text-3xl md:text-5xl text-center md:text-left text-white font-extrabold">
            Privacy and Security
          </p>
        </div>
        <div className="flex justify-start flex-wrap w-auto h-2/3 md:h-auto md:w-2/3">
          <div className="flex items-center md:items-start gap-4 md:flex-col md:w-1/2 p-4">
