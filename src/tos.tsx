      ...
      <div className="flex justify-center font-publicSans p-4 sm:p-8">
        <div className="flex flex-col gap-2 md:gap-6 w-[428px] font-semibold text-xs sm:text-base md:text-lg md:leading-[26px]">
          ...
          <p>
            ...
            <a href="https://www.dataminion.ai" className="underline">
              www.dataminion.ai
            </a>
          ...
          <p>
            1. License Grant
            <br />
            Subject to the terms and conditions of this Agreement, DATAMINION
            grants you a limited, non-exclusive, non-transferable, revocable
            license to use the Service for your personal or commercial use
          ...
          <p>
            ...
            <br />
            • Use the Service in any unlawful manner or for any unlawful
            purpose.
            <br />• Upload, post, or transmit any content that is infringing,
            libelous, defamatory, obscene, pornographic, abusive, or otherwise
            objectionable.
            <br />• Attempt to gain unauthorized access to any portion or
            feature of the Service, or any other systems or networks connected
            to the Service.• Interfere with or disrupt the operation of the
            Service or any servers or networks used to provide the Service.
          </p>
          ...
          <p>
            ...
            OF ANY KIND. DATAMINION DISCLAIMS ALL WARRANTIES, EXPRESS OR
          ...
          <p>
            ...
            <br />
            IN NO EVENT SHALL DATAMINION BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            SPECIAL, EXEMPLARY, OR CONSEQUENTIAL DAMAGES ARISING OUT OF OR IN
            CONNECTION WITH THE USE OR PERFORMANCE OF THE SERVICE, WHETHER OR
            NOT DATAMINION HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
          </p>
          <p>
            9. Governing Law
            <br />
            This Agreement shall be governed by and construed in accordance with
            the laws of the United States and the State of Washington, without
          ...
          <p>
            ...
            DATAMINION regarding your use of the Service and supersedes all
          ...
          <p>
            11. Modifications
            <br />
            DATAMINION reserves the right to modify or update this Agreement at
            any time by posting the revised terms on the DATAMINION website.
